...
from slacker.backend.chat import Chat
from slacker.backend.commands import allowed_commands
from slacker.backend.response import to_message
...
class RequestHandler:
    ...
    def handle_request(self, payload: dict) -> None:
        try:
            ...
            self.bot.client.chat_postMessage(channel=payload['event']['channel'], text="Fatal Error")
