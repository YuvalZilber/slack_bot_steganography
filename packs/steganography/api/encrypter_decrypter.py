...
from packs.steganography.api.common import Steganographer
from packs.steganography.api.decrypter import StegImageDecrypter, StegDecrypter
from packs.steganography.api.encrypter import StegImageEncrypter, StegEncrypter
...
class StegEncrypterDecrypter(
    Steganographer[CarrierType, ContentType, EncSettingsType], ABC
):
...
class StegImageEncrypterDecrypter(
    StegEncrypterDecrypter[np.ndarray, ContentType, int], ABC
):
